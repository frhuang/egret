var GameStart = (function (_super) {
    ...
    p.init = function () {
        ...
        mc.frameRate = 12;
        mc.gotoAndPlay(0, -1);
        var start_btn = new MyButton("olympic.btn1", "olympic.btn1");
        ...
        egret.Tween.get(start_btn, { loop: true })
            .to({ rotation: -6 }, 300)
            .to({ rotation: 0 }, 300);
        var start_title = ResourceUtils.createBitmapByName("olympic.page1_1");
        this.addChild(start_title);
        start_title.x = width - start_title.width / 2;
        start_title.y = height - 120;
        var finger = ResourceUtils.createBitmapByName('olympic.page1_2');
